...
### Workstream A: Core Features (Tasks 01-06, 13-15)
...
| 14 | §8.2 Deployment & mTLS Enrollment, §7 Implementation Guide |
| 15 | §6 Deployment, §7 Implementation Guide, §5.5 Config |
...
|------|--------------|--------------|
| 1 | Tasks 01, 02, 03 | Tasks 07, 09, 10 |
| 2 | Tasks 04, 05, 06 | Tasks 08, 11, 12 |
| Final | Task 13 (module prep), 14 (enroll), then 15 (docs) | Support |
